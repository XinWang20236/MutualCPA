...
class GINBert(torch.nn.Module):
    def __init__(self, num_features_xd = 78, protein_name = None):
        ...
        self.proteinsfile = torch.load('/home/yongnayuan/wx/GIN-ESM/AD-exp/protein-pt/' + self.protein_name + '.pt').cuda()
        # self.proteinsfile = torch.load('davis_proteins.pt').cuda()
        # ["ACE-P12821", "CARHSP1-Q9Y2V2", "CTSH-P09668", "DOC2A-Q14183", "ICA1L-Q8NDH6", 
        # "LACTB-P83111", "PLEKHA1-Q9HB21", "RTFDC1-Q9BY42", "SNX32-Q86XE0", "STX4-Q12846", "STX6-O43752"]
    ...
    def forward(self, data):
        ...
        x, mask = to_dense_batch(x, batch, max_num_nodes = 56)
