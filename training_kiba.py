...
datasets = [['kiba'][int(sys.argv[1])]] #, 'kiba'
...
for dataset in datasets:
    ...
    # train_data = CPADataset(processed_data_file_train)
    # test_data = CPADataset(processed_data_file_test)
    ...
    #     test_loss, G, P = predicting(model, device, test_loader, epoch + 1)
    #     ret = [0, mse(G, P), 0, get_rm2(G, P), ci(G, P)]
    #     writer.add_scalar('Loss/Test', test_loss, epoch+1)
    ...
    #         best_ci = ret[-1]
    #         best_rm_2 = ret[3]
    #         print('mse improved at epoch ', best_epoch, '; best_mse,best_ci,best_rm_2:', best_mse, best_ci, best_rm_2, model_st, dataset)
    #     else:
    #         print(ret[1], 'No improvement since epoch ', best_epoch, '; best_mse,best_ci,best_rm_2:', best_mse, best_ci, best_rm_2, model_st, dataset)
    ...
    #     test_loss = predicting(model, device, test_loader, epoch + 1)
    ...
    #         best_epoch = epoch + 1
    #         best_mse = ret[0]
    #         print('mse improved at epoch ', best_epoch, '; best_loss:', best_mse, model_st, dataset)
    #     else:
    #         print(ret[0], 'No improvement since epoch ', best_epoch, '; best_mse :', best_mse, model_st, dataset)